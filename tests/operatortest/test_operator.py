...
from plugins.operators.alternating_operator import AlternatingOperator, ConditionOperator
...
class Print2OperatorContext(ConditionOperator):
    ...
    def __init__(self, n,  *args, **kwargs):
        ...
        self.condition = True
        self.out = ""
        super(Print2OperatorContext, self).__init__(condition=self.condition, *args, **kwargs)
...
class OperatorTest(unittest.TestCase):
    def setUp(self) -> None:
        self.operators = [PrintOperator(n=4, task_id="1"), PrintOperator(n=4, task_id="2")]
        self.operators2 = [Print2Operator(n=4, task_id="5"), Print2Operator(n=4, task_id="6")]

    def test_numerical(self):
        alternating = AlternatingOperator(operators=self.operators, n_tasks=4, task_id="3")
        alternating.execute("")
    ...
    def test_numerical_with_context(self):
        operators = [PrintOperatorContext(n=4, task_id="10"), PrintOperatorContext(n=4, task_id="9")]
