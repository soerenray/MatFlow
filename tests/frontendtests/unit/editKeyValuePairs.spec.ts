...
describe('EditKeyValuePairs.vue', () => {
  // (method) getKeyValuePairsAsTupleArray(keyValuePairs:
  // Array<KeyValuePair>): Array<[string, string]>
  it('getKeyValuePairsAsTupleArray', () => {
    ...
    expect(wrapper.vm.getKeyValuePairsAsTupleArray(editKeyValuePairsObject.keyValuePairs))
      .toEqual(keyValuePairsAsTupleArray);
  });
});
