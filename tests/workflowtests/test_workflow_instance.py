...
class TestActivateInstance(unittest.TestCase):
    def setUp(self):
        ...
        self.airflow_dag_path = Path(os.path.join(Path(p.parent.parent.parent.absolute()), "dags"))
    ...
    def test_activate_instance_(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.airflow_dag_path, "test_instance.py")))
