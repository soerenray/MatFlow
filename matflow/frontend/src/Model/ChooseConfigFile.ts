...
class ChooseConfigFile {
    ...
    */
    constructor(workflowIntancesAndConfigFilesNames: Array<[string, string[]]> = [], chosenConfigFile: ConfigFile = new ConfigFile(), updatedConfigFiles: ConfigFile[] = [], selectedWorkflowInstanceName = '', selectedConfigFileName = '') {
    ...
    * @param workflowIntancesAndConfigFilesNames The new value of
    *                                            _workflowIntancesAndConfigFilesNames
    */
    public set workflowIntancesAndConfigFilesNames(workflowIntancesAndConfigFilesNames:
      Array<[string, string[]]>) {
      this._workflowIntancesAndConfigFilesNames = workflowIntancesAndConfigFilesNames;
    }
