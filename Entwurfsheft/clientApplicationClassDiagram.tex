...
\class{ServerConfig}
\begin{figure}[H]
\centerline{\includegraphics[width=\textwidth]{FrontendDocsAsPDF/Model/ServerConfig.pdf}}
\end{figure}
...
\class{Version}
\begin{figure}[H]
\centerline{\includegraphics[width=\textwidth]{FrontendDocsAsPDF/Classes/Version.pdf}}
\end{figure}
