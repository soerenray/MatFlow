...
\includepdf[pages=1,  scale=0.75,pagecommand=\subsection{Controller} \classWithoutPage{BackendServerCommunicator}]{FrontendDocsAsPDF/Controller/BackendServerCommunicator.pdf}
