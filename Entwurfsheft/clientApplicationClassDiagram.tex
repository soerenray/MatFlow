\includepdf[pages=1,  scale=0.75,pagecommand=\section{Paketbeschreibung} \subsection{Client Application} \subsubsection{Model} \class{Approval}]{FrontendDocsAsPDF/Model/Approval.pdf}
...
\includepdf[pages=1,  scale=0.75,pagecommand=\subsection{Controller} \class{BackendServerCommunicator}]{FrontendDocsAsPDF/Controller/BackendServerCommunicator.pdf}
\includepdf[pages=2-,  scale=0.8]{FrontendDocsAsPDF/Controller/BackendServerCommunicator.pdf}


\includepdf[pages=1,  scale=0.75,pagecommand=\subsubsection{JsonTypeScriptConverter} \class{convertJSONToTypeScript}]{FrontendDocsAsPDF/JSONTypeScriptConverter/convertJSONToTypeScript.pdf}
...
\includepdf[pages=1,  scale=0.75,pagecommand=\subsubsection{Classes} \class{ConfigFile}]{FrontendDocsAsPDF/Classes/ConfigFile.pdf}
