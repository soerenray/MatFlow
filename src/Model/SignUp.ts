...
class SignUp {
    ...
    * @param showPasswordRepeated True if the repeated
    *                             password should be displayed in plain text otherwise false
    */
    constructor(userName = '', userPassword = '', userPasswordRepeated = '', showPassword = false, showPasswordRepeated = false) {
    ...
    */
    ...
    public setSignUpMemento(signUpMemento: SignUpMemento) {
      const tempSignUpObject = signUpMemento.signUpObject;
